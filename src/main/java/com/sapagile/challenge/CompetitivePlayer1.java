 ...
 */
public class CompetitivePlayer1 extends AbstractPlayer{
    ...
    protected DominoTile addTileToTop(DominoTile currentTile){
        ...
        /* Try and add tile from tile set to top with max pips */
    ...
    protected DominoTile addTileToBottom(DominoTile currentTile){
        /* Try and add tile from tile set to bottom with max pips */
